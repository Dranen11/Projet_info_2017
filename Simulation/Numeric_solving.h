 ...
 */
void simulation_1D(std::basic_ostream output, size_t freq_writing, double length, size_t N_x, double simulation_time, size_t N_t, double* position,double (*potential)(double, double, double*), double* param_potential, void (*numeric_solving)(double, size_t, double, double*, double (*potential)(double, double, double*), double*));
